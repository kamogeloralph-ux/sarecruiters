...
function applyTheme(theme) {
  ...
  if (mIcon) mIcon.innerHTML = theme === 'light'
    ? '<svg viewBox="0 0 24 24"><use href="icons.svg#icon-1"></use></svg>'
    : '<svg viewBox="0 0 24 24"><use href="icons.svg#icon-2"></use></svg>';
  if (mLabel) {
...
function hubCard(a) {
  ...
  var verifiedCheck = a.verified ? '<span class="verified-check" title="Verified"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-36"></use></svg></span>' : '';
  // Jobs badge: only shows when there is at least 1 vacancy; placed at right end of card
  var jobsBadge = vCount > 0 ? '<span class="hub-stat hub-stat-right" title="' + vCount + ' job' + (vCount===1?'':'s') + '"><span class="hub-stat-num"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-23"></use></svg>' + vCount + '</span></span>' : '';
...
function hubVacancies(a) {
  ...
  if (!list.length) {
    ...
    list.forEach(function(v) {
      ...
      if (isAdmin) {
        html += '<div style="text-align:right;margin:-4px 0 10px;"><button class="hub-row-del" data-ripple onclick="deleteVacancy(\'' + v.id + '\',\'' + a.id + '\')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-37"></use></svg></button></div>';
      }
    });
  }
  html += '</div>';
...
function hubBranches(a) {
  var ICON_PIN   = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-22"></use></svg>';
  var ICON_PHONE = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-38"></use></svg>';
  var ICON_MAIL  = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-33"></use></svg>';
  var ICON_BUILD = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-39"></use></svg>';
    ...
    list.forEach(function(b) {
      ...
      html += '<div class="branch-block-head">' +
        ...
        (isAdmin ? '<div class="branch-block-actions">' +
          '<button class="hub-row-edit" data-ripple title="Edit branch" onclick="openBranchSheet(\'' + a.id + '\',\'' + b.id + '\')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-40"></use></svg></button>' +
          '<button class="hub-row-del" data-ripple title="Delete branch" onclick="deleteBranch(\'' + b.id + '\',\'' + a.id + '\')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-37"></use></svg></button>' +
        '</div>' : '') +
      '</div>';
...
function hubContact(a) {
  var ICON_PHONE  = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-38"></use></svg>';
  var ICON_EMAIL  = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-33"></use></svg>';
  var ICON_WEB    = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-41"></use></svg>';
  var ICON_PIN    = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-22"></use></svg>';
  var ICON_BUILD  = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-39"></use></svg>';
  var ICON_BRIEF  = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-42"></use></svg>';
  var ICON_SEND   = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-43"></use></svg>';
...
function starsHtml(filled) {
  ...
  for (var i = 1; i <= 5; i++) {
    html += i <= filled
      ? '<svg viewBox="0 0 24 24" fill="currentColor" class="lb-star lb-star-on"><use href="icons.svg#icon-9"></use></svg>'
      : '<svg viewBox="0 0 24 24" fill="currentColor" class="lb-star lb-star-off"><use href="icons.svg#icon-9"></use></svg>';
  }
  html += '</span>';
  return html;
}
...
function renderRatingBoard() {
  ...
  ranked.forEach(function(a, idx) {
    ...
    html += '</div>';
    html += '<span class="lb-rate-btn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-9"></use></svg>Rate</span>';
    html += '</button>';
...
function hubRatings(a) {
  ...
  if (ratings.length > 0) {
    ...
    html += '<div class="rate-list-title"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-9"></use></svg>Public Ratings (' + ratings.length + ')</div>';
    // Overall score row
    ...
    ratings.forEach(function(r) {
      ...
      if (isAdmin) {
        ...
        html += '<button class="rate-action-btn" data-ripple onclick="openEditRatingSheet(\'' + r.id + '\',\'' + a.id + '\')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-45"></use></svg>Edit</button>';
        html += '<button class="rate-action-btn danger" data-ripple onclick="deleteRating(\'' + r.id + '\',\'' + a.id + '\')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-46"></use></svg>Delete</button>';
        html += '</div>';
      }
      html += '</div>';
    });
...
function prefIcon(pref) {
  ...
  if (p === 'whatsapp') return '<svg viewBox="0 0 24 24" fill="currentColor"><use href="icons.svg#icon-32"></use></svg>';
  if (p === 'email') return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><use href="icons.svg#icon-33"></use></svg>';
  if (p === 'website') return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><use href="icons.svg#icon-41"></use></svg>';
  if (p === 'walk-in') return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><use href="icons.svg#icon-22"></use></svg>';
  return '';
}
...
var ICON_CHEVRON = '<svg viewBox="0 0 24 24" fill="none"><use href="icons.svg#icon-47"></use></svg>';
var STAR_SVG = '<svg viewBox="0 0 24 24"><use href="icons.svg#icon-9"></use></svg>';
...
var ICON_LOCK    = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-48"></use></svg>';
var ICON_UNLOCK  = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-49"></use></svg>';
var ICON_LINK    = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-50"></use></svg>';
var ICON_CHAT    = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-11"></use></svg>';
var ICON_HEART   = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-12"></use></svg>';
var ICON_FLAG    = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-13"></use></svg>';
var ICON_BOOK    = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-14"></use></svg>';
var ICON_DOC     = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-15"></use></svg>';
var ICON_SPARKLE = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-16"></use></svg>';
var ICON_MIC     = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-17"></use></svg>';
var ICON_SCALES  = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-18"></use></svg>';
var ICON_HELP    = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-19"></use></svg>';
var ICON_PIN     = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-22"></use></svg>';
var ICON_BRIEFCASE = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-23"></use></svg>';
var ICON_BUILDING = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-31"></use></svg>';
var ICON_PHONE   = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-51"></use></svg>';
var ICON_MAIL    = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-33"></use></svg>';
var ICON_WARN    = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-44"></use></svg>';
var ICON_CHECK   = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-36"></use></svg>';
var ICON_CLOSE   = '<svg viewBox="0 0 24 24"' + IS + '><use href="icons.svg#icon-37"></use></svg>';
...
function vacancyCard(v, agency) {
  ...
  if (isAdmin && isGeneral) {
    admin = '<div class="vac-admin-actions">' +
      '<button class="rate-action-btn" data-ripple onclick="event.stopPropagation();openEditGeneralVacancySheet(\'' + v.id + '\')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-45"></use></svg>Edit</button>' +
      '<button class="rate-action-btn danger" data-ripple onclick="event.stopPropagation();deleteGeneralVacancy(\'' + v.id + '\')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-46"></use></svg>Delete</button>' +
    '</div>';
  }
...
var VAC_ICONS = {
  pin:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-22"></use></svg>',
  briefcase:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-23"></use></svg>',
  doc:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-52"></use></svg>',
  money:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-53"></use></svg>',
  clock:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-54"></use></svg>',
  calendar:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-55"></use></svg>',
  building:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-56"></use></svg>',
  mail:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-33"></use></svg>',
  phone:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-38"></use></svg>',
  apply:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-57"></use></svg>',
  globe:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-58"></use></svg>',
  star:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-9"></use></svg>',
  edit:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-59"></use></svg>',
  trash:'<svg viewBox="0 0 24 24"><use href="icons.svg#icon-46"></use></svg>'
};
...
function renderAllBranchesList() {
  ...
  var html = list.map(function(b){
    ...
    return '<div class="branch-row">' +
      ...
      (b.location ? '<div class="br-loc"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:13px;height:13px;flex-shrink:0;margin-top:1px"><use href="icons.svg#icon-22"></use></svg>' + escapeHtml(b.location) + '</div>' : '') +
      (contactHtml ? '<div class="br-contact">' + contactHtml + '</div>' : '') +
      (isAdmin ? '<div class="br-actions">' +
        '<button class="br-edit" data-ripple onclick="openBranchSheet(\'' + (b.agency_id||'') + '\',\'' + b.id + '\')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-40"></use></svg> Edit</button>' +
        '<button class="br-del" data-ripple onclick="deleteBranchAllList(\'' + b.id + '\')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><use href="icons.svg#icon-46"></use></svg> Delete</button>' +
      '</div>' : '') +
    '</div>';
  }).join('');
  el.innerHTML = html;
  ...
  if (branches.length) {
    branches.forEach(function(b) {
      bHtml += '<div class="manager-item">' +
        ...
        (b.location ? '<div class="manager-item-sub">' + '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:13px;height:13px;vertical-align:-2px;margin-right:4px"><use href="icons.svg#icon-22"></use></svg>' + escapeHtml(b.location) + '</div>' : '') +
        (b.phone ? '<div class="manager-item-sub">' + '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:13px;height:13px;vertical-align:-2px;margin-right:4px"><use href="icons.svg#icon-51"></use></svg>' + escapeHtml(b.phone) + '</div>' : '') +
        (b.email ? '<div class="manager-item-sub">' + '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:13px;height:13px;vertical-align:-2px;margin-right:4px"><use href="icons.svg#icon-33"></use></svg>' + escapeHtml(b.email) + '</div>' : '') +
  ...
  if (vacancies.length) {
    vacancies.forEach(function(v) {
      vHtml += '<div class="manager-item">' +
        ...
        (v.location ? '<div class="manager-item-sub">' + '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:13px;height:13px;vertical-align:-2px;margin-right:4px"><use href="icons.svg#icon-22"></use></svg>' + escapeHtml(v.location) + '</div>' : '') +
